        ...
        children: [
          ...
          _GuideSection(
            ...
            children: const [
              ...
              '点击任务可进入客户详情；任务可延期一天、完成或取消，处理后仍会保留在历史记录中。',
              '也可以在客户详情“动态”页新建任务；手工任务可继续编辑，自动任务由对应业务记录维护。',
              '今日页右上角可全局搜索客户、联系人、项目、订单和跟进记录。',
              '首页出现“自动任务待同步”时，业务数据已经保存；点击重试，或下次启动时由应用自动修复。',
            ],
          ),
          _GuideSection(
            ...
            children: const [
              ...
              '保存客户时会提示相同电话或可能同名/同公司的现有客户；确认确实不同后仍可保存。',
              '客户列表同时显示负责人、开放任务数量和最近任务时间；右上角可进入全局搜索。',
              '客户详情分为“概览、项目、业务、动态”：资料和联系人看概览，报价、样品、注册、招标和订单在业务中维护，计划和跟进历史集中在动态。',
              '项目名称、负责人、阶段、状态、预计金额、概率、日期、障碍和下一步等关键修改会保留在“动态”的项目变更中。',
          ...
          _GuideSection(
            ...
            children: const [
              ...
              '可选择联系人和客户态度；历史会保留跟进发生时的联系人姓名、客户态度和负责人快照，联系人后续改名或删除不会改变旧记录。每次沟通新增一条记录，不覆盖历史；保存后系统会同步项目状态并生成提醒。',
